...
# =====================================================================
# SUBSISTEMAS (Lógica de Negocio - SOLID y Contenedores)
# =====================================================================

class SubsistemaAutenticacion:
    """Gestiona el almacenamiento, lectura y CRUD de credenciales y roles."""
        ...
        if os.path.exists(self.archivo):
            try:
                ...
                if not all(usuario in datos_cargados for usuario in self._cuentas_oficiales):
                    ...
                    # Asegurar al menos que las cuentas base existan si faltan
...
class SubsistemaNegocio:
    """Gestiona la persistencia y lógica de Restaurantes, Carrito y Pedidos."""
    def __init__(self):
...
# =====================================================================
# PATRÓN ESTRUCTURAL: FACADE (Fachada unificada)
# =====================================================================
...
class ICINFAppDelivery:
    ...
    def crear_pestaña_administrador(self):
        ...
        # --- PANEL IZQUIERDO: VISUALIZADOR DE CUENTAS ---
